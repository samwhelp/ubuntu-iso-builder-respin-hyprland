...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-hyprland](https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-hyprland.git
```


> change dir to `ubuntu-iso-builder-respin-hyprland`

``` sh
cd ubuntu-iso-builder-respin-hyprland
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-hyprland/dist`
